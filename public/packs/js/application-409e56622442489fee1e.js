...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(2:6) The `bg-indigo` class does not exist, but `btn-indigo` does. If you're sure that `bg-indigo` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  1 |     #nav-tab .active a {\n> 2 |       @apply bg-indigo text-white;\n    |      ^\n  3 |     }\n  4 | \n");
...
/******/ });
//# sourceMappingURL=application-409e56622442489fee1e.js.map