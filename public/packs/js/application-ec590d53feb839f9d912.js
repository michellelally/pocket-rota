...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(12:4) The `bg-indigo-dark` class does not exist, but `bg-indigo-100` does. If you're sure that `bg-indigo-dark` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  10 | \n  11 |    &:hover {\n> 12 |     @apply bg-indigo-dark text-white;\n     |    ^\n  13 |    }\n  14 | \n");
...
/******/ });
//# sourceMappingURL=application-ec590d53feb839f9d912.js.map