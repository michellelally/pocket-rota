...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(2:3) The `text-indigo` class does not exist, but `text-indigo-50` does. If you're sure that `text-indigo` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  1 | .tab {\n> 2 |    @apply p-5 no-underline inline-block text-indigo;\n    |   ^\n  3 |    transition: ease 0.2s all;\n  4 |    margin-bottom: -1px;\n");
...
/******/ });
//# sourceMappingURL=application-ff7b9105bb9da1601828.js.map