...
/* harmony import */ var stylesheets_application__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! stylesheets/application */ "./app/javascript/stylesheets/application.scss");
/* harmony import */ var stylesheets_application__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(stylesheets_application__WEBPACK_IMPORTED_MODULE_4__);
...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(283:2) The `border-grey-light` class does not exist. If you're sure that `border-grey-light` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  281 | .btn-default {\n  282 |   box-shadow: 0 1px 2px rgba(#444444, 0.1);\n> 283 |   @apply bg-white border border-grey-light text-grey-darker;\n      |  ^\n  284 | \n  285 |   &:hover, &:focus {\n");
...
/******/ });
//# sourceMappingURL=application-460587ae00b694232ceb.js.map