...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(45:2) The `bg-indigo-light` class does not exist. If you're sure that `bg-indigo-light` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  43 | \n  44 | .btn-primary {\n> 45 |   @apply bg-indigo-light text-indigo-lightest shadow;\n     |  ^\n  46 | \n  47 |   &:hover, &:focus {\n");
...
/******/ });
//# sourceMappingURL=application-24fc779943a4c34bec5a.js.map