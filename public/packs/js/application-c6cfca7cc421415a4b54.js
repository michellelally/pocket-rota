...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(4:2) The `bg-indigo` class does not exist, but `btn-indigo` does. If you're sure that `bg-indigo` exists, make sure that any `@import` statements are being properly processed before Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  2 | \n  3 | #nav-tab .active a {\n> 4 |   @apply bg-indigo text-white;\n    |  ^\n  5 | }\n  6 | \n");
...
/******/ });
//# sourceMappingURL=application-c6cfca7cc421415a4b54.js.map